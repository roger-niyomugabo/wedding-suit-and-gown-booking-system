...
<br><br><br><br>
    ...
    <form action="Loginservlet" method ="post">
      <input type="text" id="login" class="fadeIn second" name="manager_username" placeholder="User name">
      <input type="password" id="password" class="fadeIn third" name="manager_password" placeholder="password">
  ...
  <div class="container text-center text-md-left mt-5" style="">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;background-color:transparent">
        <p>
          <a href="#!">Suits </a>
        </p>
        <p>
