...
//rs.setBlob("img")
%>
<a href="managerregistration.jsp"> <button class="btn btn-primary">ADD USER</button></a>
<br>
...
<td><%=resultSet.getString("manager_names") %></td>
<td><%=resultSet.getString("manager_email") %></td>
<td><a href="deleteManager.jsp?id=<%=resultSet.getString("manager_id")%>">Delete</a></td>
